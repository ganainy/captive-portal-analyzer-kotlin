...
public class ConnectionDescriptor {
    ...
    public void processUpdate(ConnectionUpdate update) {
        ...
        if((update.update_type & ConnectionUpdate.UPDATE_PAYLOAD) != 0) {
            ...
            assert(decryption_ignored || isNotDecryptable() || CaptivePortalApp.getInstance().isDecryptingPcap());
    ...
    public DecryptionStatus getDecryptionStatus() {
        ...
        else if(decryption_ignored || (CaptivePortalApp.getInstance().isDecryptingPcap() && !internal_decrypt))
    ...
    public boolean isNotDecryptable()   { return !decryption_ignored && (encrypted_payload || !mitm_decrypt) && !CaptivePortalApp.getInstance().isDecryptingPcap(); }
