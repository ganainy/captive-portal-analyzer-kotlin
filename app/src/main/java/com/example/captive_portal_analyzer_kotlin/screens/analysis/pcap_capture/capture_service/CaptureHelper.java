...
import com.example.captive_portal_analyzer_kotlin.screens.analysis.pcap_capture.CaptureStartListener;
...
public class CaptureHelper {
    ...
    private void captureServiceResult(final ActivityResult result) {
        if(result.getResultCode() == Activity.RESULT_OK)
            ...
            Utils.showToastLong(mContext, com.example.captive_portal_analyzer_kotlin.R.string.vpn_setup_failed);
